    ...
    <div>
      <div className="page-header" style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
        <div>
          ...
          <p className="page-sub">Live Alpaca positions · {portfolio?.alpaca_mode === "paper" ? "Paper trading mode" : "Live trading"}</p>
        </div>
        {portfolio?.alpaca_mode === "paper" && (
        ...
        {loading ? (
          ...
          <div style={{ textAlign: "center", padding: 40 }}>
            ...
            <p style={{ color: "var(--text3)", fontSize: 12, marginTop: 8 }}>
              Positions will appear here once trades are executed
            </p>
          </div>
        ) : (
              ...
              {portfolio.positions.map(p => {
                ...
                return (
                  <tr key={p.symbol}>
                    ...
                    <td>
                      <span style={{ fontFamily: "var(--mono)", fontSize: 13 }}>{p.qty}</span>
                    </td>
                    <td>
                    ...
                    <td>
                      <span style={{ fontFamily: "var(--mono)", fontSize: 13, color: isUp ? "var(--green)" : "var(--red)" }}>
                        {isUp ? "+" : ""}${pnl.toFixed(2)}
                      </span>
                    </td>
                    <td>
                      <span style={{ fontFamily: "var(--mono)", fontSize: 12, color: isUp ? "var(--green)" : "var(--red)" }}>
