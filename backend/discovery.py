...
HALAL_UNIVERSE = [
    ...
    "TXN", "ADI", "MCHP", "SWKS", "MPWR", "ENTG", "ONTO", "ACLS",
    # ── Software & Cloud ──
    "MSFT", "GOOGL", "ORCL", "CRM", "ADBE", "NOW", "SNOW", "DDOG", "PANW",
    "CRWD", "NET", "ZS", "MDB", "GTLB", "HUBS", "TEAM", "OKTA",
    "VEEV", "WDAY", "ANSS", "CDNS", "SNPS", "PTC", "PAYC", "PCTY",
